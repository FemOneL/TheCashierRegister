...
public class ChecksDAO extends DAO {
     ...
     */
    public void deleteCheck(Check check) throws DatabaseException {
     ...
     */
    public void deleteSpecificGoodsInCheck(Check check, int goodsId) throws DatabaseException {
        Connection connection = null;
        try {
            connection = getConnection();
            connection.setAutoCommit(false);
     ...
     */
    public void deleteSpecificGoodsInCheck(Check check, int goodsId, int diff) throws DatabaseException {
        Connection connection = null;
        try {
            connection = getConnection();
            connection.setAutoCommit(false);
     ...
     *
     */
    public void addGoodsInCheck(Set<Goods> goodsSet, Check check) throws DatabaseException {
        Connection connection = null;
        try {
            connection = getConnection();
            connection.setAutoCommit(false);
