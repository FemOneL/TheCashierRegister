...
class AuthorizeServletTest {
    private final static String path = "WEB-INF/view/authorization.jsp";
    private AuthorizeServlet servlet;
    ...
    @Test
    public void testAuthorizeDoGet() throws ServletException, IOException {
